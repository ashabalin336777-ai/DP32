...
COPY schema.sql ./
COPY src ./src
COPY data/scrape_targets.json data/product_cards.json data/extract_selectors.json \
     data/catalog_seeds.json data/our_catalog.html data/platan_catalog.html \
